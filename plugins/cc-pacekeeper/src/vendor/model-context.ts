...
// Upstream: src/utils/model-context.ts @ 151521ca6e
//
// Modifications:
//   - USABLE_CONTEXT_RATIO and DEFAULT_CONTEXT_WINDOW_SIZE re-exported so
//     callers can scale to the same "usable" denominator ccstatusline uses
//     for context-percentage-usable.
...
export const USABLE_CONTEXT_RATIO = 0.8;
